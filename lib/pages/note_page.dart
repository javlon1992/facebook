...
class _NotePageState extends State<NotePage> {
  ...
  Future<void> _store() async {
    ...
    bool result = await Preference.storeNoteList(listNotes);
    setState(() {});
  }
  ...
  void initState() {
    super.initState();
    Preference.loadNoteList().then((value) => setState(() {
          listNotes = value;
        }));
  }
...
//  extentRatio: 0.25,
//  children: [Container(margin: EdgeInsets.fromLTRB(1, 5, 4, 1),
//  decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(8.0)),),
//  child: SlidableAction(
//  label: 'Share',backgroundColor: Colors.indigo,
//  icon: Icons.share,
//  onPressed: (context) {},),)],),